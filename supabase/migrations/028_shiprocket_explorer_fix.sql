-- 028_shiprocket_explorer_fix.sql
-- Repair explorer view when 025 billing columns or 027 view refresh were not applied.
-- Safe to run even if 025/027 partially succeeded.
