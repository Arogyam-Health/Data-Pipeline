-- 047_primary_forward_shiprocket_matching.sql
-- Rebuild Day 3 mapping so reverse shipments do not create false ambiguity.
-- Preserve genuine multiple-forward ambiguity.
